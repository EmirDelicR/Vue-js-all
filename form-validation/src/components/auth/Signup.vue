    ...
    <div id="signup">
        <div class="signup-form">
            <form @submit.prevent="onSubmit">
                <div class="input" :class="{invalide: $v.email.$error}">
                ...
                <div class="input" :class="{invalide: $v.age.$error}">
                    <label for="age">Your Age</label>
                    <input type="number" id="age" @blur="$v.age.$touch()" v-model.number="age">
                    <p v-if="!$v.age.required">Must not be empty</p>
                ...
                <!-- {{$v.terms}} -->
                <div class="input inline" :class="{invalide: !$v.terms.$model}">
...
.input.invalide label {
  color: red;
}

.input.invalide input {
